  ...
  const steps = [
    {
      ...
      description: 'Renseignez la commune et la catégorie de votre bien.',
    },
    {
      number: '2',
      icon: Settings,
      title: 'Précisez les critères',
    ...
    },
    {
      ...
      description: 'Recevez une fourchette de prix basée sur le marché local.',
    },
  ];
    ...
    <section id="how-it-works" className="py-16 md:py-24 bg-slate-50">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-slate-600 text-center max-w-2xl mx-auto mb-16">
          Obtenez une estimation fiable en trois étapes simples
        </p>
