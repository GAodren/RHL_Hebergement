...
export default function RapportEstimation() {
  ...
  const { result, formData, adjustedPrice, commission, bienPhoto, photosSupplementaires, nomClient, texteAnalyseMarche, texteEtudeComparative, texteSynthese, fromDashboard, estimationId, sectionVisibility, hiddenComparables } = location.state || {};
