...
export default function RapportEstimation() {
  ...
  const { result, formData, adjustedPrice, bienPhoto, photosSupplementaires, nomClient, texteAnalyseMarche, texteEtudeComparative, texteSynthese, fromDashboard, estimationId, sectionVisibility, hiddenComparables } = location.state || {};
